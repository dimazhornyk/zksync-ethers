...
const IZkSyncStateTransition_json_1 = __importDefault(require("../abi/IZkSyncStateTransition.json"));
 ...
 * @constant
 */
exports.ZKSYNC_MAIN_ABI = new ethers_1.utils.Interface(IZkSyncStateTransition_json_1.default);
/**
...
function isETH(token) {
    return (isAddressEq(token, exports.LEGACY_ETH_ADDRESS) ||
        ...
        isAddressEq(token.toLowerCase(), exports.ETH_ADDRESS_IN_CONTRACTS));
}
exports.isETH = isETH;
/**
